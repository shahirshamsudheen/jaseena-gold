        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <address className="not-italic text-ivory/60 text-sm font-body leading-relaxed space-y-4">
              ...
              <div>
                {/* [PLACEHOLDER CONTACT] — Phone to be confirmed by client */}
                <p>
                  <span className="text-ivory/40 text-xs">Tel: </span>
                  <a href="tel:+91XXXXXXXXXX" className="hover:text-warm-gold transition-colors min-h-0">
                    +91 XXXXX XXXXX
                  </a>
                </p>
                {/* [PLACEHOLDER CONTACT] — Email to be confirmed by client */}
                <p>
                  <span className="text-ivory/40 text-xs">Email: </span>
                  <a href="mailto:info@jaseenagold.com" className="hover:text-warm-gold transition-colors min-h-0">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="text-ivory/50 hover:text-warm-gold transition-colors min-h-0"
                aria-label="Contact us on WhatsApp (placeholder)"
              >
