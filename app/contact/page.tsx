                   ...
                   <div className="bg-white p-8 rounded-sm shadow-sm border border-muted/10 h-full">
                      ...
                      <div className="space-y-8 font-body text-sm">
                         <div>
                            ...
                            {/* Contact Phone */}
                            <a href="tel:+919447452528" className="text-emerald hover:text-warm-gold transition-colors text-lg">
                               +91 94474 52528
                            </a>
                         ...
                         <div>
                            ...
                            {/* Contact Email */}
                            <a href="mailto:jaseenagoldanddiamonds@gmail.com" className="text-emerald hover:text-warm-gold transition-colors">
                         ...
                         <div>
                            ...
                            {/* WhatsApp Contact */}
                            <a href="https://wa.me/919447452528" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366]/10 text-[#075E54] rounded-sm hover:bg-[#25D366]/20 transition-colors mt-2">
